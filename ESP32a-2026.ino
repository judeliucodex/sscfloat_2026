...
void runStepperSequence() {
    // Spin anticlockwise until BUTTON_PIN_1 is pressed
    digitalWrite(dirPin, HIGH);
    //dirPin LOW = clockwise

    // CHANGED: Wait for HIGH (unpressed state)
    ...
    // Spin clockwise until BUTTON_PIN_2 is pressed
